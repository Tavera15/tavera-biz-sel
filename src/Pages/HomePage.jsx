        ...
        <div className="col-12 justify-content-center align-items-center">
            ...
            <div>
                ...
                <div className="container p-4 mb-4 d-flex flex-wrap justify-content-evenly">
                    ...
                    <div className="col-6 col-md-2 p-1"><Link to="/products/furniture/bookcases" className="col-12 bg-white rounded-circle d-flex align-items-center "><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/8984522/8984522" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="bookcases"/></Link></div>
                    <div className="col-6 col-md-2 p-1"><Link to="/products/furniture/cabinetsanddrawers" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/450074/450074" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="Cabinets"/></Link></div>
                    <div className="col-6 col-md-2 p-1"><Link to="/products/furniture/whiteboards" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/123946/123946" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="whiteboards"/></Link></div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="container p-4 mb-4 d-flex flex-wrap justify-content-evenly">
                    ...
                    <div className="col-6 col-md-2 p-1"><Link to="/products/supplies/calculators" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/7276012/7276012" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="calculators"/></Link><h4>Calculators</h4></div>
                    <div className="col-6 col-md-2 p-1"><Link to="/products/supplies/electroniclabels" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/938678/938678" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="e-labels"/></Link><h4>Label Makers & Tape</h4></div>
                    <div className="col-6 col-md-2 p-1"><Link to="/products/supplies/bags" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/7851084/7851084" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="bags"/></Link><h4>Bags</h4></div>
                    <div className="col-6 col-md-2 p-1"><Link to="/products/supplies/shredders" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/427604/427604" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="shredders"/></Link><h4>Shredders</h4></div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="container p-4 mb-4 d-flex flex-wrap justify-content-evenly">
                    <div className="col-6 col-md-2 p-1"><Link to="/products/tech/telephones" className="col-12 bg-white rounded-circle d-flex align-items-center"><img className="col-12 rounded-circle" src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/638562/638562" style={{ "objectFit": "contain", "aspectRatio": "1/1", "width": "100%"}} alt="Telephones"/></Link><h4>Telephones</h4></div>
                </div>
            </div>
